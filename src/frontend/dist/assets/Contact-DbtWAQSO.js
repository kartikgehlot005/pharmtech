import { R as React, a as useActor, r as reactExports, j as jsxRuntimeExports, c as createActor } from "./index-BfL2YKX-.js";
import { L as Layout, a as Label } from "./Layout-BJ9Xxx6n.js";
import { c as createLucideIcon, m as motion, B as Button, I as Input } from "./proxy-C2WaRF_8.js";
import { T as Textarea } from "./textarea-BuSOifED.js";
import { i as isOk } from "./api-TKou_e4I.js";
import { M as Mail } from "./mail-CVV3hslS.js";
import { L as Linkedin, Y as Youtube } from "./youtube-Dmzg0oHW.js";
...
function ContactPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen py-20 px-4 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pointer-events-none absolute inset-0 -z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-primary/10 blur-[100px]" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl md:text-6xl font-bold tracking-tight mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "Contact " }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent", children: "Us" })
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-muted-foreground font-body text-lg max-w-xl mx-auto", children: "Have a question, collaboration idea, or just want to connect? Reach out below." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-semibold text-foreground mb-6", children: "Send a Message" }),
              submitState === "success" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-16 h-16 text-primary" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold text-foreground", children: "Thank you!" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body", children: "Your message has been received. We'll get back to you soon." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        variant: "outline",
                ...
                "form",
                {
                  ...
                  children: [
                    ...
                    submitState === "error" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      motion.div,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-5 h-5 text-destructive shrink-0" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-destructive text-sm font-body", children: errorMessage })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        ...
                        children: submitState === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "span",
                          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-2xl p-8 border border-accent/30", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-semibold text-foreground mb-3", children: "Dr. Ashwin Singh Chouhan" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body leading-relaxed", children: "Pharmacologist & Researcher. Feel free to reach out for academic collaborations, research inquiries, or general correspondence." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", "data-ocid": "contact.social.list", children: SOCIAL_LINKS.map((link, idx) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.a,
                  {
                    ...
                    className: `group flex items-center gap-4 glass-card rounded-xl p-4 border transition-smooth cursor-pointer no-underline ${isCyan ? "border-primary/20 hover:border-primary/60 hover:glow-cyan" : "border-accent/20 hover:border-accent/60 hover:glow-fuchsia"}`,
                    "data-ocid": `contact.social.item.${idx + 1}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: `flex items-center justify-center w-12 h-12 rounded-xl shrink-0 transition-smooth ${isCyan ? "bg-primary/15 text-primary group-hover:bg-primary/25" : "bg-accent/15 text-accent group-hover:bg-accent/25"}`,
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-6 h-6" })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-xs uppercase tracking-widest mb-0.5", children: link.label }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            className: `font-body font-medium text-sm truncate ${isCyan ? "text-primary" : "text-accent"}`,
                            children: link.value
                          }
                        )
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ExternalLink,
                        {
                          className: `w-4 h-4 shrink-0 opacity-0 group-hover:opacity-100 transition-smooth ${isCyan ? "text-primary" : "text-accent"}`
                        }
                      )
                    ]
                  },
                ...
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-primary pulse-glow" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-sm font-semibold text-primary uppercase tracking-wider", children: "Available for Collaborations" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-sm leading-relaxed", children: "Open to research partnerships, academic discussions, and guest lectures in pharmacology and drug discovery." })
                  ]
                }
              )
            ]
